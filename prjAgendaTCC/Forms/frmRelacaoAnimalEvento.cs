...
namespace prjAgendaTCC
{
    public partial class frmRelacaoAnimalEvento : Form
    {
        ...
        private void btnAddAnimal_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Atenção: Selecione um animal para poder adiciona-lo a lista!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            if (NovaRelação == false)
            {
                ...
                MessageBox.Show("Relações salvas com sucesso!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                Evento = (frmNovoEvento)this.Owner;
